...
const Hero = () => {
    ...
    return (
        <div className='mx-6 overflow-hodden'>
            <div className='flex flex-col lg:flex-row gap-4 sm:gap-8 max-w-7xl mx-auto my-10'>
                <div className='relative flex-1 flex flex-col bg-green-200 rounded-3xl xl:min-h-100 group overflow-hidden'>
                    ...
                    {/* Image for Medium device */}
                    <Image className='hidden md:block lg:hidden xl:block absolute bottom-4 right-2 max-w-full' src={assets.hero_model_img_copy} alt="Hero image" />

                    {/* Image for Medium device */}
                    <Image className='block md:hidden lg:block xl:hidden absolute bottom-0 -right-18 sm:-right-6 lg:-right-28 w-full max-w-sm sm:max-w-lg lg:max-w-2xl' src={assets.hero_model_img} alt="hero image" />
                </div>
                <div className='flex flex-col md:flex-row lg:flex-col gap-5 w-full lg:max-w-sm text-sm text-slate-600'>
                    <div className='flex-1 flex items-center justify-between w-full bg-orange-200 rounded-3xl p-6 px-8 group'>
                        ...
                        <Image className='w-35' src={assets.hero_product_img1} alt="Hero earphone image" />
                    </div>
                    <div className='flex-1 flex items-center justify-between w-full bg-blue-200 rounded-3xl p-6 px-8 group'>
                        ...
                        <Image className='w-35' src={assets.hero_product_img2} alt="Hero watch image" />
                    </div>
                </div>
            </div>
            <CategoriesMarquee />
